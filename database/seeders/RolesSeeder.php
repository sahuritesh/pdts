        ...
        $roles = [
            ...
            [
                ...
                'permission_types' => implode(',', array_merge(
                    ['dashboard_view', 'users', 'delay_categories', 'projects', 'delay_registers', 'mitigations', 'financial_impacts', 'delay_attachments', 'renovation_projects'],
                    RoleManagement::allDashboardPermissionKeys()
                )),
                'status' => 1,
                'created_by' => 1,
            ...
            [
                ...
                'permission_types' => implode(',', array_merge(
                    ['dashboard_view', 'projects', 'delay_registers', 'mitigations', 'delay_categories', 'financial_impacts', 'renovation_projects'],
                    RoleManagement::allDashboardPermissionKeys()
                )),
                'status' => 1,
                'created_by' => 1,
